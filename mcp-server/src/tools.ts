  ...
  return {
    ...
    memory_write: {
      ...
      shape: {
        ...
        scopeId: z.string().optional().describe("User/channel ID for scoped memories (omit for global)"),
    ...
    memory_search: {
      ...
      shape: {
        ...
        scopeId: z.string().optional().describe("User/channel ID for scoped search (omit for global)"),
